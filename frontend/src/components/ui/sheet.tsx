...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="absolute right-4 top-6 p-1 rounded-md opacity-70 transition-opacity hover:opacity-100 hover:bg-slate-100 focus:outline-none disabled:pointer-events-none data-[state=open]:bg-transparent">
