...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PublicApi.Domain.Vaccinations.Vaccination", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("PublicApi.Domain.Visits.Visit", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("PublicApi.Domain.Clinics.Clinic", b =>
                {
                    b.HasOne("PublicApi.Domain.Users.User", "Doctor")
                        .WithOne("Clinic")
                        .HasForeignKey("PublicApi.Domain.Clinics.Clinic", "DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PublicApi.Domain.Subscriptions.Subscription", b =>
                {
                    ...
                    b.HasOne("PublicApi.Domain.Subscriptions.Subscription", null)
                        .WithOne()
                        .HasForeignKey("PublicApi.Domain.Subscriptions.Subscription", "PreviousSubscriptionId")
                        .OnDelete(DeleteBehavior.Restrict)
            ...
            modelBuilder.Entity("PublicApi.Domain.Vaccinations.Vaccination", b =>
                {
                    ...
                    b.HasOne("PublicApi.Domain.Visits.Visit", "Visit")
                        .WithMany()
            ...
            modelBuilder.Entity("PublicApi.Domain.Visits.Visit", b =>
                {
                    ...
                    b.HasOne("PublicApi.Domain.Appointments.Appointment", "Appointment")
                        .WithMany()
                        .HasForeignKey("AppointmentId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_visits_appointments_appointment_id");

                    b.HasOne("PublicApi.Domain.Clients.Client", "Owner")
                        .WithMany("Visits")
