...
public static class DeactivateMachine
{
    ...
    public sealed class Endpoint : IEndpoint
    {
        ...
        {
            app.MapPatch("attendance/machines/{id:guid}/deactivate", async (
                Guid id,
            ...
            .WithTags("Attendance")
            .WithSummary("Deactivate an attendance machine")
            .WithDescription("Deactivates an attendance machine so it is skipped by the import endpoint.");
        }
    }
}